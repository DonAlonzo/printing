...
module spring(r=5, R=40, windings=5, H=150, center = true, R1 = undef, start=false, end=false, ends=undef, w = undef, h=undef, reverse=false)
{
  N = $fn?$fn:180/$fa; 
  ...
  {
    tr = spring(r, R, windings, H, R1, w, h, reverse); 
    sweep(tr);   
